...
const EditorWelcome = (props) => {
  ...
  return (
    <section className='p-4 bg-white rounded-lg shadow-lg h-full'>
      <div className='text-center mb-4'>
        <p><strong>Hi User! </strong>I am your writing assistant</p>
        ...
        <ul>
          {
            buttonsName.map((item) => {
              return (
                <motion.li
                  className='flex justify-between items-center m-2 p-2 myList cursor-pointer list-none border rounded-lg gap-y-4'
